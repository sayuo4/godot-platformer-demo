...
## [b]Note:[/b] The value of this variable will be multiplied by [method get_default_gravity_force]
...
## Maximum value that the gravity can reach
...
## [b]Note:[/b] The value of this variable will be multiplied by [member gravity_limit]
